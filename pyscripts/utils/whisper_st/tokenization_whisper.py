...
class WhisperTokenizer(PreTrainedTokenizer):
    ...
    def all_special_ids(self):
        # Cihan: This is to fix the bug that for some reason, after adding the new unused tokens such as
        # mask_token, when the SpecialTokensMixin is constructed, it iterates over this first, and
        # thus the order of the added tokens get's messed up.
        return list(sorted(super().all_special_ids))
